...
Notes:
    ...
    cd ~/code/xinspect/docs
    sphinx-apidoc --private --separate --force --output-dir ~/code/xinspect/docs/source/auto ~/code/xinspect/xinspect
    ...
    Also:
        ...
        https://readthedocs.org/dashboard/xinspect/advanced/
        ...
        Enter the following information:
            Set the Repository NAME: xinspect
            Set the Repository URL: https://github.com/Erotemic/xinspect

        Make sure you have a .readthedocs.yml file

        For gitlab you also need to setup an integrations. Navigate to:

            https://readthedocs.org/dashboard/xinspect/integrations/create/
        ...
        Then go to
            ...
            https://github.com/Erotemic/xinspect/hooks
        ...
        Will also need to activate the main branch:
            https://readthedocs.org/projects/xinspect/versions/
"""
#
...
mod_dpath = join(repo_dpath, 'xinspect')
...
# html_logo = '.static/xinspect.svg'
# html_favicon = '.static/xinspect.ico'
...
latex_documents = [
    (master_doc, 'xinspect.tex', 'xinspect Documentation',
     'Jon Crall', 'manual'),
]
...
man_pages = [
    (master_doc, 'xinspect', 'xinspect Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'xinspect', 'xinspect Documentation',
     author, 'xinspect', 'One line description of project.',
     'Miscellaneous'),
]
