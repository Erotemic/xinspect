"""
Notes:
    Based on template code in: ~/code/xinspect/docs/source/conf.py
    ...
    sphinx-apidoc -f -o ~/code/xinspect/docs/source ~/code/xinspect/xinspect --separate
    make html
